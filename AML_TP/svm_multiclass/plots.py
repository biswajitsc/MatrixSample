...
with open('Experiments_Data_BinarySVM.csv') as f:
...
for n in N :
	...
	plt.legend()
	plt.savefig('mean_error_N_'+str(n)+'.pdf')
	plt.close()
...
for d in D :
	...
	plt.legend()	
	plt.savefig('mean_error_D_'+str(d)+'.pdf')
	plt.close()
...
for n in N :
	...
	plt.legend()	
	plt.savefig('variance_N_'+str(n)+'.pdf')
	plt.close()
...
for d in D :
	...
	plt.legend()
	plt.savefig('variance_D_'+str(d)+'.pdf')
	plt.close()